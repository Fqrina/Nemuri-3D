...
namespace Nemuri.UI
{
    public class OverlayImageUnorderedPuzzleUI : MonoBehaviour
    {
        ...
        [Tooltip("The set of slot indices (0-indexed, e.g. 0 for Slot 1, 7 for Slot 8) that must be selected.")]
        [SerializeField] private List<int> _correctPinIndices = new List<int> { 0, 7 };
        ...
        private void Update()
        {
            if (_enableKeyboardToggle && Keyboard.current != null && Keyboard.current.lKey.wasPressedThisFrame)
            {
                TogglePuzzleUI();
            }
        }
        ...
        private void EnsureUIBuilt()
        {
            ...
            _overlayContainer = new GameObject("PuzzleOverlayPanel_L", typeof(RectTransform));
        ...
        private void BuildRightPinPanel(Transform parent)
        {
            ...
            titleText.text = "IMAGE UNORDERED (L)";
