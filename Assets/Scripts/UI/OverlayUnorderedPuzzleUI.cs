...
namespace Nemuri.UI
{
    public class OverlayUnorderedPuzzleUI : MonoBehaviour
    {
        ...
        [SerializeField] private List<string> _correctPins = new List<string> { "A", "H" };
        ...
        private void Update()
        {
            if (_enableKeyboardToggle && Keyboard.current != null && Keyboard.current.hKey.wasPressedThisFrame)
            {
                TogglePuzzleUI();
            }
        }
        ...
        private void EnsureUIBuilt()
        {
            ...
            _overlayContainer = new GameObject("PuzzleOverlayPanel_H", typeof(RectTransform));
